...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="#" class="btn btn-success rounded-pill px-3 mb-3 align-content-between" style="float: right;">+ Tambah Jadwal Periksa</a>
      <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                    $result = $pdo->query("SELECT jadwal_periksa.*, dokter.nama FROM jadwal_periksa LEFT JOIN dokter ON jadwal_periksa.id_dokter = dokter.id");
                    $no = 1;
