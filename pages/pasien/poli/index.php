    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/BK_Poliklinik/pages/pasien/poli" class="nav-link">
              <p>
                Poli
                <span class="right badge badge-danger">Pasien</span>
              </p>
...
<script>
  ...
  function loadJadwal(poliId){
    ...
    //atur header untuk permintaan ajax
    xhr.setRequestHeader('Content-Type', 'text/html');

    // Atur fungsi callback ketika permintaan selesai
    xhr.onload = function(){
      if(xhr.status === 200){
        //Jika permintaan berhasil, perbahari opsi pada select pilih jadwal
